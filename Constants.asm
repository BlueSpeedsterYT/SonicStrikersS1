...
; Joypad addresses
jpad_init_1:	equ $A10009 ; Joypad port 1 init address
jpad_port_1:	equ $A10003 ; Joypad port 1 address
jpad_init_2:	equ $A1000B ; Joypad port 2 init address
jpad_port_2:	equ $A10005 ; Joypad port 2 address
jpad_init_3:	equ $A1000D ; Joypad port 3 (expansion/extra) init address
jpad_port_3:	equ $A10007 ; Joypad port 3 (expansion/extra) address
...
revspeed:	equ $3A	; rev speed for Spin Dash or Dash
